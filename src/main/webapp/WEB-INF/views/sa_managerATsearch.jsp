...
<body>
<form action="sa_managerATconsearch">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<div class="search">
			...
			<div class="row">
				<div class="col-md-12">
	<form action="sa_managerATpayupdate">
	<hr>
	...
	<table>
		...
		<tbody>
		<c:forEach items="${assigntestList}" var="assigntest">
			<tr>
				<td><strong><a href="sa_managerSTUmodify?account=${assigntest.account}">${assigntest.account}</a></strong></td>
				<td>${assigntest.testid}</td>
				<td>${assigntest.money}</td>
				<td>${assigntest.type}</td>
				<td>${assigntest.code}</td>
				<td>${assigntest.testplace}</td>
				<td>${assigntest.identity}</td>
				<td>${assigntest.state}</td>
				<td>${assigntest.note}</td>
				<td><a class="btn btn-default" href="sa_managerATupdate?account=${assigntest.account}">修改</a>
			    </td>
				<td><input type="checkbox" id="test5" name="checkbox" value="${assigntest.account}" /> <label for="test5"></label> 
			</tr>
			</c:forEach>
		</tbody>
	</table>
