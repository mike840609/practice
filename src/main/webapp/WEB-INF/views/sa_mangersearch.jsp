...
body {
	font-family: "Open sans", "Segoe UI", "Segoe WP", Helvetica, Arial,
		sans-serif;
	color: #777;
}
...
<%@include file="sa_navbar.jspf" %>
	...
	<div class="checkbox1">
		<form action="#">
			<p>
				<input type="checkbox" id="test1" /> <label for="test1">中低收戶</label>
				<input type="checkbox" id="test2" checked="checked" /> <label
					for="test2">低收入戶</label> <input type="checkbox" id="test3"
					checked="checked" disabled="disabled" /> <label for="test3">未繳費</label>
				<input type="checkbox" id="test4" disabled="disabled" /> <label
					for="test4">已繳費</label>
				<section class="container">
				<div class="wrapper">
					<a href="#" class="button blue">
						<div class="light"></div>修改資料
					</a>
	...
	<table>
		...
		<tbody>
			<tr>
				...
				<td>非洲</td>
				<td>副二代</td>
				<td><input type="checkbox" id="test5" /> <label for="test5">已繳費</label>
			</tr>
			<tr>
