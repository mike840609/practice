...
<body>
<form action="sa_managerBTconsearch">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<div class="search">
	...
	<table>
		...
		<tbody>
		<c:forEach items="${basictestList}" var="basictest">
			<tr>
				<td><strong><a href="sa_managerSTUmodify?account=${basictest.account}">${basictest.account}</a></strong></td>
				<td>${basictest.testid}</td>
				<td>${basictest.money}</td>
				<td>${basictest.type}</td>
				<td>${basictest.code}</td>
				<td>${basictest.testplace}</td>
				<td>${basictest.identity}</td>
				<td>${basictest.state}</td>
				<td>${basictest.note}</td>
				<td><a class="btn btn-default" href="sa_managerBTupdate?account=${basictest.account}">修改</a>
			    </td>
				<td><input type="checkbox" id="test5" name="checkbox" value="${basictest.account}" /> <label for="test5"></label> 
			</tr>
			</c:forEach>
		</tbody>
	</table>
