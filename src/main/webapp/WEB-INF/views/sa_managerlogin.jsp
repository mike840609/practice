...
<body>
    ...
    <div class="wrapper">
        <div class="container" >
            <h1>Welcome</h1>
             <form action = "sa_managerlogin" class="form"  method="post">
                
                <input type="text" placeholder="Username" class="input1" name="managerusername"> 
                <input type="password" placeholder="Password" class="input1" name="managerpassword">
