...
public class ManagerDAOImpl implements ManagerDAO{
	...
	//update�Ǵ����
		public void updateBT(sa_managerBasicTest basictest) {
			// TODO Auto-generated method stub
			String sql = "UPDATE sa_basictest SET testid=?, state=?, testPlace=?"
					+ "WHERE account = ?";
			try {
				conn = dataSource.getConnection();
				smt = conn.prepareStatement(sql);
		...
		//update�Ǵ����
				public void updateAT(sa_managerAssignTest assigntest) {
					// TODO Auto-generated method stub
					String sql = "UPDATE sa_assigntest SET testid=?, state=?, testPlace=?"
							+ " WHERE account = ?";
					try {
						conn = dataSource.getConnection();
						smt = conn.prepareStatement(sql);
	...
	public void updateEL(sa_managerEnglishListening englishlistening) {
		// TODO Auto-generated method stub
		String sql = "UPDATE sa_englishlistening SET testid=?, state=?, testPlace=?"
				+ "WHERE account = ?";
		try {
			conn = dataSource.getConnection();
			smt = conn.prepareStatement(sql);
	...
	public void payupdateBT(sa_managerBasicTest basictest) {
		...
		String sql = "UPDATE sa_basictest SET state = '�wú�O'"
				+ "WHERE account = ?";
		try {
			conn = dataSource.getConnection();
			smt = conn.prepareStatement(sql);
	...
	//�Ǵ��妸�ק窱�A
		public void payupdateAT(sa_managerAssignTest assigntest) {
			...
			//�ŧi�}�C����
			for(int i = 0;i < length;i++){
			String sql = "UPDATE sa_assigntest SET state = '�wú�O'"
					+ "WHERE account = ?";
			try {
				conn = dataSource.getConnection();
				smt = conn.prepareStatement(sql);
	...
	public void payupdateEL(sa_managerEnglishListening englishlistening) {
		...
		//�ŧi�}�C����
		for(int i = 0;i < length;i++){
		String sql = "UPDATE sa_englishlistening SET state = '�wú�O'"
				+ "WHERE account = ?";
		try {
			conn = dataSource.getConnection();
			smt = conn.prepareStatement(sql);
	...
	public void updateBTscore(sa_managerBasicTest basictest) {
		// TODO Auto-generated method stub
		String sql = "UPDATE sa_basictest SET Chinese=?, Math=?, English=?, Society=?, Science=?"
				+ "WHERE account = ?";
		try {
			conn = dataSource.getConnection();
			smt = conn.prepareStatement(sql);
	...
	public void updateATscore(sa_managerAssignTest assigntest) {
		...
		String sql = "UPDATE sa_assigntest SET Chinese=?, MathA=?, MathB=?, English=?, Geography=?, "
				+"History=?, Civics=?, Physical=?, Chemical=?, Biology=? "
				+ "WHERE account=?";
		try {
			conn = dataSource.getConnection();
			smt = conn.prepareStatement(sql);
	...
	public void updateELscore(sa_managerEnglishListening englishlistening) {
		// TODO Auto-generated method stub
		String sql = "UPDATE sa_englishlistening SET score=? "
				+ "WHERE account=?";
		try {
			conn = dataSource.getConnection();
			smt = conn.prepareStatement(sql);
